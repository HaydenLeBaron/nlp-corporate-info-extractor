...
def get_predictor():
    #return Predictor.from_path("TODO")
    #return Predictor.from_path("https://s3-us-west-2.amazonaws.com/allennlp/models/srl-model-2018.05.25.tar.gz") #{{Hayden: This model no longer works}}
    return Predictor.from_path("https://storage.googleapis.com/allennlp-public-models/structured-prediction-srl-bert.2020.12.15.tar.gz") #{{Should work for pip3 install allennlp==2.1.0 allennlp-models==2.1.0}}
    #return Predictor.from_path("TODO")
