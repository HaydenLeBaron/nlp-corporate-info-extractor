"""
Code from: https://orbifold.net/default/what-is-semantic-role-labeling/
Using this as part of my learning process. {{Hayden}}
"""
...
def demo():
    ...
    for w in doc:
        if w.pos_ == "VERB":
            ...
            # ('Apple', 'sold', '1 million Plumbuses)if __name__ == '__main__':
demo()
